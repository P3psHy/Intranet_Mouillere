          ...
          <div class="logo_campus"><a target="_blank" rel="noopener noreferrer" href="https://campuslamouillere.fr"><img src="img/logo_campuslamouillere.png" style="width: 140px";></a></div>
            <div class="panel_ressource">
              ...
              <div class="panel_ressource_note">
                <div class="box3">
                  <a class="button3" target="_blank" rel="noopener noreferrer" href="https://drive.google.com/drive/folders/1bM4JCy-g5q1ftKlc6gcXL6hq5TO5GDOF?usp=share_link"><img src="img/icons/note-collante.png" style="width: 100px;"><span- style="color:white;">Note de service</span-></a>
                </div>
              </div>
              <div class="panel_ressource_car">
                ...
                <div id="popup4" class="overlay">
                  <div class="popup4">
                    ...
                    <a class="close" href="#">&times;</a>
                    <div class="content">
                      <h2>Vous pouvez ici réservée les véhicules de la mouillere</h2>
                      <br>
                      <div class="button-car">
                        <a target="_blank" rel="noopener noreferrer" href="document/documents-utiles/procedure-voiture.pdf">Procédure</a>
                        <a target="_blank" rel="noopener noreferrer" href="https://calendar.google.com/calendar/u/0/r">Agenda</a>
                        <br>
                        <br><embed src="document/documents-utiles/procedure-voiture.pdf" width="750" height="400" type="application/pdf"/>
                      </br>
                      </div>
                    </div>
                  </div>
